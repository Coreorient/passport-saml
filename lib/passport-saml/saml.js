...
//**** COREORIENT EDIT ****
// 
// The signicat SAML response has a different format from what passport-saml assumes
// The Subject is part of the AttributeStatement and not available on the Asserton root
//
// Second edit is dealing with an obvious logic bug
//
//*************************
// Original line
//   var subject = assertion.Subject;
// Replacement
// var subject = assertion.AttributeStatement && assertion.AttributeStatement.Subject;
//*************************
    var subject = assertion.AttributeStatement && assertion.AttributeStatement.Subject;
    if (subject) {
...
// EDIT: The if-block ended here, but 'subject' is accessed in the next 
//       couple of paragraphs as well
//    }
// END EDIT
...
// EDIT: We extend the if-block untill here
    }
// END EDIT
